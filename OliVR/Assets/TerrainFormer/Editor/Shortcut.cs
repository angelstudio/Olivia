...
namespace JesseStiller.TerrainFormerExtension {
    internal class Shortcut {
        ...
        internal static readonly Dictionary<string, Shortcut> Shortcuts = new Shortcut[] {
            ...
            new Shortcut("Rotate Brush Counterclockwise", "'"),
            ...
            new Shortcut("Select Raise/Lower Mode", "z"),
            new Shortcut("Select Smooth Mode", "x"),
            new Shortcut("Select Set Height Mode", "c"),
            new Shortcut("Select Flatten Mode", "v"),
            new Shortcut("Select Generate Mode", "b"),
            new Shortcut("Select Settings Tab", "n"),
        ...
        internal bool WasExecuted(Event currentEvent) {
            return currentEvent.Equals(Event.KeyboardEvent(Binding));
        }
